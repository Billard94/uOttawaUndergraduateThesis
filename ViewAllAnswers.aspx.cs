...
namespace OSCS
{
    public partial class ViewAllAnswers : System.Web.UI.Page
    {
        ...
        private void fillgrid()
        {
            try
            {
                ...
                cmd.CommandText = "Select q.questionid, q.QuestionType, q.questiondescription, a.answer, a.HospitalPatientID, a.RegisteredPatientID " +
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "Select q.questionid, q.QuestionType, q.questiondescription, a.answer, a.HospitalPatientID, a.RegisteredPatientID " +
                                  "from answers a, questions q " +
                                  "where a.questionid = q.questionid AND CONCAT_WS('|',`QuestionType`,`questiondescription`,`answer`, `HospitalPatientID`, `RegisteredPatientID`) LIKE '%" + txtsearch.Text + "%' ";
                da = new MySqlDataAdapter(cmd);
                da.Fill(ds);
                dt = ds.Tables[0];
                Session["MAINSORTING"] = dt;
