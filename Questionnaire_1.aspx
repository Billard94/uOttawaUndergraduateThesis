<%@ Page Title="" Language="C#" MasterPageFile="~/Mastermain.Master" AutoEventWireup="true" CodeBehind="Questionnaire_1.aspx.cs" Inherits="OSCS.Questionnaire_1" %>
                ...
                <ContentTemplate>
                    ...
                    <div id="textdiv1" runat="server" style="margin-left: auto; margin-right: auto; ">
                        ...
                        <asp:GridView ID="Stringquestions1" runat="server" HorizontalAlign="Center" OnRowCreated="OnRowCreatedText1" OnSelectedIndexChanged="SelectedIndexChangedText1"
                            AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" DataKeyNames="questionid" OnPageIndexChanging="Stringquestions1_PageIndexChanging">
                            <Columns>
                    ...
                    <div id="textdiv2" runat="server" style="margin-left: auto; margin-right: auto; ">
                        ...
                        <asp:GridView ID="Stringquestions2" runat="server" HorizontalAlign="Center" OnRowCreated="OnRowCreatedText2" OnSelectedIndexChanged="SelectedIndexChangedText2"
                            AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" DataKeyNames="questionid" OnPageIndexChanging="Stringquestions2_PageIndexChanging">
                            <Columns>
                    ...
                    <div id="Radiodiv1" runat="server" style="margin-left: auto; margin-right: auto; ">
                        ...
                        <asp:GridView ID="Radio1" runat="server" HorizontalAlign="Center" OnRowCreated="OnRowCreatedRadio1" OnSelectedIndexChanged="SelectedIndexChangedRadio1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Better" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="cbloption1" runat="server" RepeatDirection="Horizontal" AutoPostBack="false">
                                ...
                                <asp:TemplateField HeaderText="Worse" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="cbloption2" runat="server" RepeatDirection="Horizontal" AutoPostBack="false">
                                ...
                                <asp:TemplateField HeaderText="Not Improving" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <ItemTemplate>
                    ...
                    <br />
                    <div id="CheckBoxdiv1" runat="server" style="margin-left: auto; margin-right: auto; ">

                        <asp:HiddenField ID="SelectedGridCellIndexCheckBox1" runat="server" Value="-1" />

                        <asp:GridView ID="CheckBox1" runat="server" HorizontalAlign="Center" OnRowCreated="OnRowCreatedCheckBox1" OnSelectedIndexChanged="SelectedIndexChangedCheckBox1"
                            AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" DataKeyNames="questionid" CssClass="" OnPageIndexChanging="CheckBox1_PageIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="questionid" HeaderText="ID" ItemStyle-Font-Bold="true" Visible="false" />
                                ...
                                <asp:TemplateField HeaderText="Sitting" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="cbloption1" runat="server" RepeatDirection="Horizontal" AutoPostBack="false">
                                            <asp:ListItem Text="" Value="0">
                                            </asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Standing" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="cbloption2" runat="server" RepeatDirection="Horizontal" AutoPostBack="false">
                                            <asp:ListItem Text="" Value="1">
                                            </asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Walking" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="cbloption3" runat="server" RepeatDirection="Horizontal" AutoPostBack="false">
                                ...
                                <asp:TemplateField HeaderText="Lying Down" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Bending Forward" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Other" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Nothing" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center text-danger" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                    <ItemTemplate>
                    ...
                    <div id="YesNodiv2" runat="server" style="margin-left: auto; margin-right: auto; ">

                        <asp:HiddenField ID="SelectedGridCellIndexYesNo2" runat="server" Value="-1" />

                        <asp:GridView ID="YesNo2" runat="server" HorizontalAlign="Center" OnRowCreated="OnRowCreatedYesNo2" OnSelectedIndexChanged="SelectedIndexChangedYesNo2"
                            AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" DataKeyNames="questionid" CssClass="" OnPageIndexChanging="YesNo2_PageIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="questionid" HeaderText="ID" ItemStyle-Font-Bold="true" Visible="false" />
                                <asp:BoundField DataField="questiondescription" HeaderText="" HeaderStyle-CssClass="text-center text-danger" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-CssClass="col-xs-6 col-sm-6 col-md-6 col-lg-6" ItemStyle-Wrap="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Size="large" />
                    ...
                    <ul class="pagination">
                        <a href="index.aspx" class="btn btn-danger" style="position:relative">&laquo;</a>
                    ...
                    <%--<asp:LinkButton ID="lbadd" Text="Submit" runat="server" CssClass="btn btn-danger" Style="position: relative" OnClick="btnAdd_Click">
                    </asp:LinkButton>--%>
                    <br />
                </ContentTemplate>
                <Triggers>
